...
router.post("/api/sessions/changePassword", userController.changeUserPassword);

router.post("/api/sessions/register", passport.authenticate("register", {failureRedirect: "/api/sessions/failregister"}), userController.userCreatedSuccessfully);

router.get("/api/sessions/failregister", userController.userCreationFailure);

router.post("/api/sessions/login", passport.authenticate("login", {failureRedirect: "/api/sessions/faillogin"}), userController.userLoggedSuccesfully);

router.get("/api/sessions/faillogin", userController.userLoginFailure);

router.get("/api/sessions/logout", userController.logoutUser);

router.get("/api/sessions/githubcallback", passport.authenticate("github", {failureRedirect: "/api/sessions/failgithub"}), userController.userGitHubSuccesfully);

router.get("/api/sessions/failgithub", userController.userGitHubFailure);
