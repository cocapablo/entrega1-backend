...
import { AnticiposController } from "../controllers/anticipos.controller.js";
...
const anticiposController = new AnticiposController();

router.get("/api/anticipos", anticiposController.getAnticipos);

router.post("/api/anticipos", anticiposController.createAnticipo); //Falta validación de permisos

router.put("/api/anticipos/:id", anticiposController.updateAnticipo); //Falta validación de permisos

router.delete("/api/anticipos/:id", anticiposController.deleteAnticipo); //Falta validación de permisos

router.get("/api/anticipos/:id", anticiposController.getAnticipoById); //Falta validación de permisos
